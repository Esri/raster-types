...
# ------------------------------------------------------------------------------
# Name: TripleSat.py
# Description: Create python raster type for TripleSat
# Version: {20181003}
...
class RasterTypeFactory():
    ...
    def getRasterTypesInfo(self):
        ...
        self.viewingAngle_auxField = arcpy.Field()
        self.viewingAngle_auxField.name = 'ViewingAngle'
        self.viewingAngle_auxField.aliasName = 'ViewingAngle'
...
class TripleSatBuilder():

    def __init__(self, **kwargs):
        self.SensorName = 'TripleSat'
...
# ----- ## ----- ## ----- ## ----- ## ----- ## ----- ## ----- ## ----- ##
# TripleSat Crawlerclass
# ----- ## ----- ## ----- ## ----- ## ----- ## ----- ## ----- ## ----- ##


class TripleSatCrawler():
    ...
    def __init__(self, **crawlerProperties):
        ...
        if not self.filter:
            self.filter = 'TRIPLESAT*.xml;TR*.dim'
        try:
